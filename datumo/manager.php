...
echo "<td><a href=javascript:void(0) title='click to view column comments' onclick=showColumnComments()>Click here to display additional information about the table</a></td>";
echo "</tr>";
echo "</table>";
