...
echo "<p style='text-align:center'>External Price without support:"  . ($calendar->getPrice())*3 . " Euros/hour + VAT"."</p>";
						...
						for ($i=0;$i<$nxfields;$i++){
							...
							echo "<tr>";
								if($arrxfields['xfields_type'] == 1){
									...
									// if($formerInputType != $arrxfields['xfields_type']){
									...
									// $type = 'checkbox';
									// $name = $arrxfields['xfields_name'].$arrxfields['xfields_id'];
									// if($arrxfields['xfields_type'] == 3){
										// $type = 'radio';
										// $name = $arrxfields['xfields_name'];
									// }
										
									// echo "<td colspan=2>";
									// echo "<label><input lang=send type=".$type." onkeypress='return noenter()' id='".$arrxfields['xfields_name'].$arrxfields['xfields_id']."' name='".$name."' value='9001!!' ".$extraHtml.">";
									// echo "&nbsp;";
									// echo $arrxfields['xfields_label']."</label>";
									// echo "</td>";
								}
