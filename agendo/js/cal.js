...
function selectDate(cal) {
	...
	//alert(p.inputField.id);
	//year = p.inputField.id.value.substring(0,3);
	//day = p.inputField.id.value.substring(8,9);
	//month =  p.inputField.id.value.substring(5,6);
	
	//document.getElementById(month).value = cal.date.print('%m');
	//document.getElementById(day).value = cal.date.print('%e');
	document.getElementById(p.inputField.id).value = cal.date.print('%Y')+ '-' +cal.date.print('%m') + '-' +cal.date.print('%d');
}
...
function selectEuropeDate(cal) {
	...
	document.getElementById(month).value = cal.date.print('%m');
	document.getElementById(day).value = cal.date.print('%d');
